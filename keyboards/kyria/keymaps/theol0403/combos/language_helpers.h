...
SUBS(tri_per, "per", KC_P, THMB_L2, KC_R)
SUBS(tri_int, "int", HM_I, HM_N, HM_T)
SUBS(tri_one, "one", HM_O, HM_N, THMB_L2)
SUBS(tri_you, "you", HM_Y, HM_O, KC_U)
END_SECTION(TRIGRAMS)

BEGIN_SECTION(NGRAMS)
SUBS(ng_that, "that", HM_T, HM_H, HM_A)
SUBS(ng_ther, "there", HM_T, THMB_L2, KC_R)
SUBS(ng_with, "with", KC_W, HM_T, HM_H)
SUBS(ng_ions, "ions", HM_I, HM_O, HM_N, HM_S)
SUBS(ng_this, "this", HM_T, HM_H, HM_S)
SUBS(ng_here, "here", HM_H, THMB_L2, KC_R)
SUBS(ng_have, "have", HM_H, HM_A, KC_V)
END_SECTION(NGRAMS)
